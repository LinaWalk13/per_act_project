...
## tried every transformation I ofund but nothing made it normal 
```
...
## summary of all tested variables 
...
### Proportion of Long to Short Fixation Duration:

 **ANOVA and Post-hoc Tests:**
   - ANOVA indicated a significant effect of the condition on the log-transformed proportion of focal to ambient fixations.
   - Post-hoc Tukey HSD and Dunn tests revealed specific pairwise group differences
...
---------+---------------------------------
      H2 |   1.429566
         |     0.4585
         |
      L1 |  -3.072619  -4.576607
         |    0.0064*    0.0000*
         |
      L2 |  -1.545007  -3.023744   1.552863
         |     0.3670    0.0075*     0.3614


### Fixation Frequency:

 **Non-Normality Test and Kruskal-Wallis Test:**
   - Shapiro-Wilk and Levene's tests indicated non-normality and unequal variances.
   - Kruskal-Wallis test was employed due to unequal variances, showing a significant effect of condition on fixation frequency 
...
---------+---------------------------------
      H2 |  -15.96033
         |    0.0000*
         |
      L1 |   19.72757   35.97493
         |    0.0000*    0.0000*
         |
      L2 |   8.066703   24.11602  -11.62566
